...
def validate_required_files(results):
    ...
    required_files = [
        ...
        "ai_robotics_cpp_pipeline/README.md",
        "ai_robotics_cpp_pipeline/glossary/README.md",
        "ai_robotics_cpp_pipeline/docs/01_ros_ecosystem_theory.md",
        "ai_robotics_cpp_pipeline/docs/02_cpp_ml_robot_pipeline.md",
        "ai_robotics_cpp_pipeline/docs/03_no_robot_simulation_testing.md",
        "ai_robotics_cpp_pipeline/docs/04_llm_agent_robot_apps.md",
        "ai_robotics_cpp_pipeline/docs/05_real_robot_testing_pipeline.md",
        "ai_robotics_cpp_pipeline/docs/06_embedded_optimization.md",
        "ai_robotics_cpp_pipeline/docs/07_daily_lab_curriculum.md",
        "ai_robotics_cpp_pipeline/docs/08_validation_report.md",
        "ai_robotics_cpp_pipeline/examples/cpp_ml_policy_node/README.md",
        "ai_robotics_cpp_pipeline/examples/cpp_ml_policy_node/src/ml_policy_node.cpp",
        "ai_robotics_cpp_pipeline/examples/cpp_ml_policy_node/src/safety_filter.cpp",
        "ai_robotics_cpp_pipeline/examples/python_agent_bridge/agent_command_bridge.py",
        "ai_robotics_cpp_pipeline/scripts/validate_ai_robotics_cpp_pipeline_docs.py",
        "robot_learning/README.md",
        "robot_learning/00_foundations/README.md",
        "robot_learning/01_pytorch_pipeline/README.md",
        "robot_learning/02_policy_learning_il_bc/README.md",
        "robot_learning/03_rl_offline_rl/README.md",
        "robot_learning/04_generative_models/README.md",
        "robot_learning/05_visual_navigation_memory/README.md",
        "robot_learning/06_vla_world_models_generative_sim/README.md",
        "robot_learning/07_simulators_closed_loop/README.md",
        "robot_learning/08_sim_to_real_deployment/README.md",
        "robot_learning/09_on_device_inference/README.md",
        "robot_learning/10_research_publication/README.md",
        "robot_learning/11_capstone/README.md",
        "robot_learning/daily_practice/README.md",
        "robot_learning/references/README.md",
        "projects/README.md",
